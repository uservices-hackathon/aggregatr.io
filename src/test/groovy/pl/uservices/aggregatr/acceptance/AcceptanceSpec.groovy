package pl.uservices.aggregatr.acceptance

import groovy.json.JsonSlurper
import org.springframework.test.context.ActiveProfiles
import org.springframework.test.context.ContextConfiguration
import org.springframework.test.web.servlet.MvcResult
import pl.uservices.aggregatr.base.MicroserviceMvcWiremockSpec
...
class AcceptanceSpec extends MicroserviceMvcWiremockSpec {
    ...
    private MvcResult getting_ingredients() {
        return mockMvc.perform(post(create('/ingredients'))
                ...
                .content('{"items":["WATER","HOP","YEAST","MALT"]}'))
                .andDo(print())
                .andReturn()
    }
